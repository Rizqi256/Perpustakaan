 ...
 <style>
     ...
     /* Style for other users' chat bubble */
     .other-bubble {
     ...
     /* Clearfix to handle floating chat bubbles */
     .clearfix::after {
         content: "";
         clear: both;
         display: table;
                 ...
                 <div id="kt_header" class="header mt-0 mt-lg-0 pt-lg-0" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{lg: '300px'}">
                     ...
                     <div class="container d-flex flex-stack flex-wrap gap-4" id="kt_header_container">
                         ...
                         <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                             <!--begin::Heading-->
                             <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Comment Section</h1>
                             <!--end::Heading-->
                                 ...
                                 <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                                     <div class="container-xxl" id="kt_content_container">
                                         <div class="card">
                                             ...
                                             <form method="post" action="<?= base_url('buku/tambah_komentar'); ?>">
                                                 <div class="mb-3">
                                                     <textarea class="form-control" id="isi_komentar" name="isi_komentar" rows="3" required></textarea>
                                                 </div>
                                                 <button type="submit" class="btn btn-primary sm">Kirim Komentar</button>
                                             </form>

                                             <!-- Daftar Komentar -->
                                             <div class="chat-container mt-4">
                                                 <?php foreach ($data_komentar as $komentar) : ?>
                                                     <?php if ($komentar->id_user == $id_user) : ?>
                                                         <!-- User's Chat Bubble -->
                                                         <div class="user-bubble clearfix">
                                                             <?= $komentar->isi_komentar; ?>
                                                             <br>
                                                             <small><?= $komentar->tanggal_komentar; ?></small>
                                                         </div>
                                                     <?php else : ?>
                                                         <!-- Other Users' Chat Bubble -->
                                                         <div class="other-bubble clearfix">
