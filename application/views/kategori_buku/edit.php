                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body py-4">
                                <form method="post" action="<?= base_url('kategori_buku/update/' . $data_kategori_buku->id_kategori_buku); ?>">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="nama_kategori" value="<?= $data_kategori_buku->nama_kategori; ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                    </div>
